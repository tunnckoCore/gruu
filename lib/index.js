 ...
 *
 * @name  test
 * @param {String|Function|Object} `[title]` name of the test, `fn`
 *                                           or options object
 * @param {Function} `<fn>` test function to be called, passed to [always-done][]
 * @return {Function} returns same function, which is also instance of `Gruu`
 *                    and so it is eventemitter, so has `.on`, `.emit` and etc methods
 * @api public
 */
